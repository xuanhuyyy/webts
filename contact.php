...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <textarea name="msg" class="box" placeholder="Nhập thông điệp của bạn" cols="30" rows="10"></textarea>
      <input type="submit" value="Gửi thông điệp" name="send" class="btn">
   </form>
